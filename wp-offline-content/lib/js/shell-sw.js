(function(self, localforage){
  ...
  var wpOfflineShell = self.wpOfflineShell = $$contents$$;

  // Instance of localForage to save urls and hashes to see if anything has changed
  wpOfflineShell.storage = localforage.createInstance({ name: wpOfflineShell.storageKey });

  // Name of the cache the plugin will use
  wpOfflineShell.cacheName = wpOfflineShell.storageKey;

  // Method to cleanse a URL before comparing and caching
  wpOfflineShell.ignoreSearch = function(request) {
  ...
  wpOfflineShell.shouldBeHandled = function(method, url) {
  ...
  wpOfflineShell.update = function() {
  ...
  wpOfflineShell.removeOldUrls = function() {
  ...
  wpOfflineShell.removeOldUrl = function(cache, request) {
  ...
  wpOfflineShell.onInstall = function(event) {
  ...
  wpOfflineShell.onActivate = function(event) {
  ...
  wpOfflineShell.onFetch = function(event) {
